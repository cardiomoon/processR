...
#'modSummary2(fit)
modSummary2=function(fit,pred=NULL,modx=NULL,pred.values=NULL,modx.values=NULL,
    ...
    attr(df,"slope")=slope
    class(df)=c("modSummary2","data.frame")
    df
}
...
#'S3 method of print
#'@param x An object of class modSummary2
#'@param ... Further argument to be passed to print()
#'@export
print.modSummary2=function(x,...){
